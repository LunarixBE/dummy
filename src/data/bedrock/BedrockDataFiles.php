...
final class BedrockDataFiles{
	...
	public const CANONICAL_BLOCK_STATES_JSON = BEDROCK_DATA_PATH . '/canonical_block_states.json';
	...
	public const LEGACY_BLOCK_ID_MAP_1_12_JSON = BEDROCK_DATA_PATH . '/block_id_map-1.12.0.json';
	public const LEGACY_ITEM_ID_MAP_1_12_JSON = BEDROCK_DATA_PATH . '/item_id_map-1.12.0.json';
	public const LEGACY_REQUIRED_BLOCK_STATES_1_12_JSON = BEDROCK_DATA_PATH . '/required_block_states-1.12.0.json';
