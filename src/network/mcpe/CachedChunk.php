...
class CachedChunk{
	 ...
	 */
	public function compressPackets(int $chunkX, int $chunkZ, int $dimensionId, string $chunkData, Compressor $compressor, PacketSerializerContext $encoderContext) : void{

		$protocolId = $encoderContext->getProtocolId();
